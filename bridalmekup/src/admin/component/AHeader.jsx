                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-md-8">
                            <ul className="info">
                                <li><i className="fa fa-envelope" />sapanapatela671@gmail.com</li>
                                <li><i className="fa fa-map" />Maninger</li>
                            ...
                            <nav className="main-nav">
                                ...
                                <ul className="nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <Link class="dropdown-item" to="/add_properties">Add Product</Link>
                                            <Link class="dropdown-item" to="/manage_properties">Manage Product</Link>
                                        </div>
                                    </li>
