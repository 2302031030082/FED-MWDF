                            ...
                            <div className="container mt-3">
                                ...
                                <form method="post" onSubmit={submitHandel}>
                                    <div className="form-floating mb-3 mt-3">
                                        <input type="text" onChange={changeHandel} value={formdata.cate_name} className="form-control"  placeholder="Enter Categories Name" name="cate_name" required />
                                        <label htmlFor="email">Categories Name</label>
                                    </div>
                                    <div className="form-floating mt-3 mb-3">
                                        <input type="url" onChange={changeHandel} value={formdata.cate_image} className="form-control" id="pwd" placeholder="Enter Categories image url" name="cate_image" required/>
