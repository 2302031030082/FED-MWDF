                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="item phone">
                                        ...
                                        <h6>7861817955<br /><span>Phone Number</span></h6>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="item email">
                                        <img src="assets/images/email-icon.png" alt style={{ maxWidth: 52 }} />
                                        <h6>sapanapatel671@gmail.com<br /><span>Email</span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <fieldset>
                                            ...
                                            <input type="name" onChange={changeHandel} value={formdata.name} name="name" id="name" placeholder="Your Name..." required/>
                                        </fieldset>
                                    </div>
                                    <div className="col-lg-12">
                                        <fieldset>
                                    ...
                                    <div className="col-lg-12">
                                        <fieldset>
                                            ...
                                            <input type="number" onChange={changeHandel} value={formdata.mobile} name="mobile" id="mobile" placeholder="Mobile..."  required/>
                                        </fieldset>
                                    </div>
                                    <div className="col-lg-12">
                                        <fieldset>
